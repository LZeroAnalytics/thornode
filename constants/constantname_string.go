...
func _() {
	...
	_ = x[HaltRebond-140]
	_ = x[HaltOperatorRotate-141]
	_ = x[RequiredPriceFeeds-142]
	_ = x[HaltOracle-143]
	_ = x[OracleUpdateInterval-144]
	_ = x[ArtificialRagnarokBlockHeight-145]
	_ = x[BondLockupPeriod-146]
	_ = x[BurnSynths-147]
	_ = x[DefaultPoolStatus-148]
	_ = x[ManualSwapsToSynthDisabled-149]
	_ = x[MaximumLiquidityRune-150]
	_ = x[MintSynths-151]
	_ = x[NumberOfNewNodesPerChurn-152]
	_ = x[SignerConcurrency-153]
	_ = x[StrictBondLiquidityRatio-154]
	_ = x[SwapOutDexAggregationDisabled-155]
}

const _ConstantName_name = ""

var _ConstantName_index = [...]uint16{0, 13, 26, 39, 61, 81, 90, 106, 123, 137, 161, 179, 198, 208, 228, 243, 256, 271, 297, 319, 347, 360, 378, 398, 421, 441, 460, 484, 508, 524, 533, 544, 561, 582, 601, 613, 634, 655, 677, 698, 716, 742, 766, 793, 807, 822, 842, 861, 877, 893, 909, 927, 947, 970, 987, 1015, 1044, 1060, 1083, 1097, 1110, 1124, 1138, 1150, 1164, 1182, 1203, 1225, 1253, 1258, 1263, 1289, 1299, 1320, 1332, 1352, 1367, 1390, 1420, 1447, 1467, 1485, 1511, 1520, 1554, 1575, 1590, 1613, 1636, 1654, 1668, 1694, 1722, 1757, 1792, 1812, 1835, 1852, 1869, 1882, 1917, 1945, 1970, 1980, 1990, 2009, 2037, 2061, 2073, 2088, 2111, 2128, 2148, 2175, 2197, 2224, 2243, 2258, 2287, 2313, 2332, 2355, 2377, 2391, 2416, 2444, 2466, 2483, 2509, 2521, 2536, 2555, 2575, 2605, 2634, 2657, 2676, 2700, 2714, 2730, 2745, 2755, 2773, 2791, 2801, 2821, 2850, 2866, 2876, 2893, 2919, 2939, 2949, 2973, 2990, 3014, 3043}
