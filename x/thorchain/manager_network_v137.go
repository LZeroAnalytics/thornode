...
// NetworkMgrV137 is going to manage the vaults
type NetworkMgrV137 struct {
	k          keeper.Keeper
	txOutStore TxOutStore
	eventMgr   EventManager
}

// newNetworkMgrV137 create a new vault manager
func newNetworkMgrV137(k keeper.Keeper, txOutStore TxOutStore, eventMgr EventManager) *NetworkMgrV137 {
	return &NetworkMgrV137{
		k:          k,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
	}
...
func (vm *NetworkMgrV137) processGenesisSetup(ctx cosmos.Context) error {
...
func (vm *NetworkMgrV137) BeginBlock(ctx cosmos.Context, mgr Manager) error {
	return vm.spawnDerivedAssets(ctx, mgr)
}

func (vm *NetworkMgrV137) suspendVirtualPool(ctx cosmos.Context, mgr Manager, derivedAsset common.Asset, suspendReasonErr error) {
...
func (vm *NetworkMgrV137) GetAvailableAnchorsAndDepths(
...
func (vm *NetworkMgrV137) CalcAnchor(ctx cosmos.Context, mgr Manager, asset common.Asset) (cosmos.Uint, cosmos.Uint, cosmos.Uint) {
...
func (vm *NetworkMgrV137) spawnDerivedAssets(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV137) SpawnDerivedAsset(ctx cosmos.Context, asset common.Asset, mgr Manager) {
	var err error
	layer1Asset := asset
...
func (vm *NetworkMgrV137) fetchWeightedMeanSlip(ctx cosmos.Context, asset common.Asset, mgr Manager) (slip int64) {
...
func (vm *NetworkMgrV137) calculateWeightedMeanSlip(ctx cosmos.Context, asset common.Asset, mgr Manager) int64 {
...
func (vm *NetworkMgrV137) EndBlock(ctx cosmos.Context, mgr Manager) error {
	if ctx.BlockHeight() == genesisBlockHeight {
...
func (vm *NetworkMgrV137) migrateFunds(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV137) paySaverYield(ctx cosmos.Context, asset common.Asset, runeAmt cosmos.Uint) error {
...
func (vm *NetworkMgrV137) POLCycle(ctx cosmos.Context, mgr Manager) error {
...
func (mv *NetworkMgrV137) fetchPOLPools(ctx cosmos.Context, mgr Manager) (Pools, []int64) {
	var pools Pools
...
func (vm *NetworkMgrV137) addPOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
...
func (vm *NetworkMgrV137) removePOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
	polAddress, asgardAddress common.Address,
	signer cosmos.AccAddress,
...
func (vm *NetworkMgrV137) TriggerKeygen(ctx cosmos.Context, nas NodeAccounts) error {
...
func (vm *NetworkMgrV137) RotateVault(ctx cosmos.Context, vault Vault) error {
	active, err := vm.k.GetAsgardVaultsByStatus(ctx, ActiveVault)
	if err != nil {
		return err
	}
...
func (vm *NetworkMgrV137) cleanupAsgardIndex(ctx cosmos.Context) error {
...
func (vm *NetworkMgrV137) withdrawSavers(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) (done bool, err error) {
	handler := NewInternalHandler(mgr)
...
func (vm *NetworkMgrV137) withdrawLPs(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) (done bool) {
	handler := NewInternalHandler(mgr)
	lpPerIteration := mgr.Keeper().GetConfigInt64(ctx, constants.RagnarokProcessNumOfLPPerIteration)
	totalCount := int64(0)
...
func (vm *NetworkMgrV137) withdrawLiquidity(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) error {
	if pool.Status == PoolSuspended {
...
func (vm *NetworkMgrV137) UpdateNetwork(ctx cosmos.Context, constAccessor constants.ConstantValues, gasManager GasManager, eventMgr EventManager) error {
...
func (vm *NetworkMgrV137) getAvailablePoolsRune(ctx cosmos.Context) (Pools, cosmos.Uint, error) {
...
func (vm *NetworkMgrV137) getVaultsLiquidityRune(ctx cosmos.Context) (cosmos.Uint, error) {
...
// Pays out Rewards
func (vm *NetworkMgrV137) payPoolRewards(ctx cosmos.Context, poolRewards []cosmos.Uint, pools Pools) error {
...
func (vm *NetworkMgrV137) calcPoolDeficit(lpDeficit, totalFees, poolFees cosmos.Uint) cosmos.Uint {
...
func (vm *NetworkMgrV137) calcBlockRewards(
	ctx cosmos.Context,
	availablePoolsRune,
	vaultsLiquidityRune,
...
func (vm *NetworkMgrV137) getPoolShare(
...
func (vm *NetworkMgrV137) deductPoolRewardDeficit(ctx cosmos.Context, pools Pools, totalLiquidityFees, lpDeficit cosmos.Uint) ([]PoolAmt, error) {
...
func (vm *NetworkMgrV137) checkPoolRagnarok(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV137) canRagnarokGasPool(ctx cosmos.Context, c common.Chain, allPools Pools) bool {
...
func (vm *NetworkMgrV137) redeemSynthAssetToReserve(ctx cosmos.Context, p Pool) error {
...
func (vm *NetworkMgrV137) ragnarokPool(ctx cosmos.Context, mgr Manager, p Pool) error {
