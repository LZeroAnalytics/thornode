...
func AddModuleInitFlags(startCmd *cobra.Command) {
	startCmd.Flags().String(FlagForkGRPC, "", "Remote gRPC endpoint for forking (e.g., thornode.ninerealms.com:9090)")
	...
	startCmd.Flags().Duration(FlagForkTimeout, 30*time.Second, "Timeout for remote gRPC calls")
