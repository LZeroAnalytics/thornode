...
type TxOutStoreV133Suite struct{}

var _ = Suite(&TxOutStoreV133Suite{})

func (s TxOutStoreV133Suite) TestAddGasFees(c *C) {
...
func (s TxOutStoreV133Suite) TestEndBlock(c *C) {
...
func (s TxOutStoreV133Suite) TestAddOutTxItem(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
...
func (s TxOutStoreV133Suite) TestAddOutTxItem_OutboundHeightDoesNotGetOverride(c *C) {
	SetupConfigForTest()
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
...
func (s TxOutStoreV133Suite) TestAddOutTxItemNotEnoughForFee(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.RuneAsset(), cosmos.NewUint(10000*common.One)),
...
func (s TxOutStoreV133Suite) TestAddOutTxItemWithoutBFT(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
...
func (s TxOutStoreV133Suite) TestCalcTxOutHeight(c *C) {
...
func (s TxOutStoreV133Suite) TestAddOutTxItem_MultipleOutboundWillBeScheduledAtTheSameBlockHeight(c *C) {
	SetupConfigForTest()
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
...
func (s TxOutStoreV133Suite) TestAddOutTxItemInteractionWithPool(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
...
func (s TxOutStoreV133Suite) TestAddOutTxItemSendingFromRetiredVault(c *C) {
	SetupConfigForTest()
	w := getHandlerTestWrapper(c, 1, true, true)
...
func (s TxOutStoreV133Suite) TestAddOutTxItem_SecurityVersusOutboundNumber(c *C) {
...
func (s TxOutStoreV133Suite) TestAddOutTxItem_VaultStatusVersusOutboundNumber(c *C) {
	// Within this example vault bonds are treated as zero, using only assets to represent security.
...
func (s *TxOutStoreV133Suite) TestSplitCloutEqualDistribution(c *check.C) {
...
func (s *TxOutStoreV133Suite) TestSplitCloutOneSideExceeds(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
...
func (s *TxOutStoreV133Suite) TestSplitCloutUnevenDistribution(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
...
func (s *TxOutStoreV133Suite) TestSplitCloutOverLimit(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
...
func (s *TxOutStoreV133Suite) TestSplitCloutWithZeroRuneValue(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
...
func (s *TxOutStoreV133Suite) TestSplitCloutCloutsAtLimit(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
	swapperCloutLimit := cosmos.NewUint(100)
...
func (s *TxOutStoreV133Suite) TestSplitCloutRuneValueExceedingClouts(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
	swapperCloutLimit := cosmos.NewUint(100)
	clout1 := cosmos.NewUint(40)
