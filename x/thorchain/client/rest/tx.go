...
func newTssPoolHandler(cliCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		msg, err := types.NewMsgTssPool(req.InputPubKeys, req.PoolPubKey, req.Secp256K1Signature, req.KeysharesBackup, req.KeygenType, req.Height, req.Blame, req.Chains, addr, req.KeygenTime)
		if err != nil {
			rest.WriteErrorResponse(w, http.StatusBadRequest, err.Error())
			return
		}
