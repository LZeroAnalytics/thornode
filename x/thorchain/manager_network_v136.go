...
// newNetworkMgrV136 create a new vault manager
func newNetworkMgrV136(k keeper.Keeper, txOutStore TxOutStore, eventMgr EventManager) *NetworkMgrV136 {
	return &NetworkMgrV136{
		k:          k,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
	}
...
func (vm *NetworkMgrV136) processGenesisSetup(ctx cosmos.Context) error {
...
func (vm *NetworkMgrV136) suspendVirtualPool(ctx cosmos.Context, mgr Manager, derivedAsset common.Asset, suspendReasonErr error) {
...
func (vm *NetworkMgrV136) spawnDerivedAssets(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV136) fetchWeightedMeanSlip(ctx cosmos.Context, asset common.Asset, mgr Manager) (slip int64) {
...
func (vm *NetworkMgrV136) calculateWeightedMeanSlip(ctx cosmos.Context, asset common.Asset, mgr Manager) int64 {
...
func (vm *NetworkMgrV136) migrateFunds(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV136) paySaverYield(ctx cosmos.Context, asset common.Asset, runeAmt cosmos.Uint) error {
...
func (mv *NetworkMgrV136) fetchPOLPools(ctx cosmos.Context, mgr Manager) (Pools, []int64) {
	var pools Pools
...
func (vm *NetworkMgrV136) addPOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
...
func (vm *NetworkMgrV136) removePOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
	polAddress, asgardAddress common.Address,
	signer cosmos.AccAddress,
...
func (vm *NetworkMgrV136) cleanupAsgardIndex(ctx cosmos.Context) error {
...
func (vm *NetworkMgrV136) withdrawSavers(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) (done bool, err error) {
	handler := NewInternalHandler(mgr)
...
func (vm *NetworkMgrV136) withdrawLPs(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) (done bool) {
	handler := NewInternalHandler(mgr)
	lpPerIteration := mgr.Keeper().GetConfigInt64(ctx, constants.RagnarokProcessNumOfLPPerIteration)
	totalCount := int64(0)
...
func (vm *NetworkMgrV136) withdrawLiquidity(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) error {
	if pool.Status == PoolSuspended {
...
func (vm *NetworkMgrV136) getAvailablePoolsRune(ctx cosmos.Context) (Pools, cosmos.Uint, error) {
...
func (vm *NetworkMgrV136) getVaultsLiquidityRune(ctx cosmos.Context) (cosmos.Uint, error) {
...
// Pays out Rewards
func (vm *NetworkMgrV136) payPoolRewards(ctx cosmos.Context, poolRewards []cosmos.Uint, pools Pools) error {
...
func (vm *NetworkMgrV136) calcPoolDeficit(lpDeficit, totalFees, poolFees cosmos.Uint) cosmos.Uint {
...
func (vm *NetworkMgrV136) calcBlockRewards(
	availablePoolsRune,
	vaultsLiquidityRune,
...
func (vm *NetworkMgrV136) getPoolShare(
...
func (vm *NetworkMgrV136) deductPoolRewardDeficit(ctx cosmos.Context, pools Pools, totalLiquidityFees, lpDeficit cosmos.Uint) ([]PoolAmt, error) {
...
func (vm *NetworkMgrV136) checkPoolRagnarok(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV136) canRagnarokGasPool(ctx cosmos.Context, c common.Chain, allPools Pools) bool {
...
func (vm *NetworkMgrV136) redeemSynthAssetToReserve(ctx cosmos.Context, p Pool) error {
...
func (vm *NetworkMgrV136) ragnarokPool(ctx cosmos.Context, mgr Manager, p Pool) error {
