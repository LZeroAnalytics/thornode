...
// NetworkMgrV132 is going to manage the vaults
type NetworkMgrV132 struct {
	k          keeper.Keeper
	txOutStore TxOutStore
	eventMgr   EventManager
}

// newNetworkMgrV132 create a new vault manager
func newNetworkMgrV132(k keeper.Keeper, txOutStore TxOutStore, eventMgr EventManager) *NetworkMgrV132 {
	return &NetworkMgrV132{
		k:          k,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
	}
...
func (vm *NetworkMgrV132) processGenesisSetup(ctx cosmos.Context) error {
...
func (vm *NetworkMgrV132) BeginBlock(ctx cosmos.Context, mgr Manager) error {
	return vm.spawnDerivedAssets(ctx, mgr)
}

func (vm *NetworkMgrV132) suspendVirtualPool(ctx cosmos.Context, mgr Manager, derivedAsset common.Asset, suspendReasonErr error) {
...
func (vm *NetworkMgrV132) GetAvailableAnchorsAndDepths(
...
func (vm *NetworkMgrV132) CalcAnchor(ctx cosmos.Context, mgr Manager, asset common.Asset) (cosmos.Uint, cosmos.Uint, cosmos.Uint) {
...
func (vm *NetworkMgrV132) spawnDerivedAssets(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV132) SpawnDerivedAsset(ctx cosmos.Context, asset common.Asset, mgr Manager) {
	var err error
	layer1Asset := asset
...
func (vm *NetworkMgrV132) fetchWeightedMeanSlip(ctx cosmos.Context, asset common.Asset, mgr Manager) (slip int64) {
...
func (vm *NetworkMgrV132) calculateWeightedMeanSlip(ctx cosmos.Context, asset common.Asset, mgr Manager) int64 {
...
func (vm *NetworkMgrV132) EndBlock(ctx cosmos.Context, mgr Manager) error {
	if ctx.BlockHeight() == genesisBlockHeight {
...
func (vm *NetworkMgrV132) migrateFunds(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV132) paySaverYield(ctx cosmos.Context, asset common.Asset, runeAmt cosmos.Uint) error {
...
func (vm *NetworkMgrV132) POLCycle(ctx cosmos.Context, mgr Manager) error {
...
func (mv *NetworkMgrV132) fetchPOLPools(ctx cosmos.Context, mgr Manager) (Pools, []int64) {
	var pools Pools
...
func (vm *NetworkMgrV132) addPOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
...
func (vm *NetworkMgrV132) removePOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
	polAddress, asgardAddress common.Address,
	signer cosmos.AccAddress,
...
func (vm *NetworkMgrV132) TriggerKeygen(ctx cosmos.Context, nas NodeAccounts) error {
...
func (vm *NetworkMgrV132) RotateVault(ctx cosmos.Context, vault Vault) error {
	active, err := vm.k.GetAsgardVaultsByStatus(ctx, ActiveVault)
	if err != nil {
		return err
	}
...
func (vm *NetworkMgrV132) cleanupAsgardIndex(ctx cosmos.Context) error {
...
func (vm *NetworkMgrV132) RecallChainFunds(_ cosmos.Context, _ common.Chain, _ Manager, _ common.PubKeys) error {
	return fmt.Errorf("dev error: RecallChainFunds is obsolete")
}

func (vm *NetworkMgrV132) withdrawSavers(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) (done bool, err error) {
	handler := NewInternalHandler(mgr)
...
func (vm *NetworkMgrV132) withdrawLPs(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) (done bool) {
	handler := NewInternalHandler(mgr)
	lpPerIteration := mgr.Keeper().GetConfigInt64(ctx, constants.RagnarokProcessNumOfLPPerIteration)
	totalCount := int64(0)
...
func (vm *NetworkMgrV132) withdrawLiquidity(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) error {
	if pool.Status == PoolSuspended {
...
func (vm *NetworkMgrV132) UpdateNetwork(ctx cosmos.Context, constAccessor constants.ConstantValues, gasManager GasManager, eventMgr EventManager) error {
...
func (vm *NetworkMgrV132) getAvailablePoolsRune(ctx cosmos.Context) (Pools, cosmos.Uint, error) {
...
func (vm *NetworkMgrV132) getVaultsLiquidityRune(ctx cosmos.Context) (cosmos.Uint, error) {
...
// Pays out Rewards
func (vm *NetworkMgrV132) payPoolRewards(ctx cosmos.Context, poolRewards []cosmos.Uint, pools Pools) error {
...
func (vm *NetworkMgrV132) calcPoolDeficit(lpDeficit, totalFees, poolFees cosmos.Uint) cosmos.Uint {
...
func (vm *NetworkMgrV132) calcBlockRewards(availablePoolsRune, vaultsLiquidityRune, effectiveSecurityBond, totalEffectiveBond, totalReserve, totalLiquidityFees cosmos.Uint, emissionCurve, blocksPerYear int64) (cosmos.Uint, cosmos.Uint, cosmos.Uint, cosmos.Uint) {
...
func (vm *NetworkMgrV132) getPoolShare(
...
func (vm *NetworkMgrV132) deductPoolRewardDeficit(ctx cosmos.Context, pools Pools, totalLiquidityFees, lpDeficit cosmos.Uint) ([]PoolAmt, error) {
...
func (vm *NetworkMgrV132) checkPoolRagnarok(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV132) canRagnarokGasPool(ctx cosmos.Context, c common.Chain, allPools Pools) bool {
...
func (vm *NetworkMgrV132) redeemSynthAssetToReserve(ctx cosmos.Context, p Pool) error {
...
func (vm *NetworkMgrV132) ragnarokPool(ctx cosmos.Context, mgr Manager, p Pool) error {
