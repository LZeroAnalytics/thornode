...
`func NewReferenceMemoResponse(asset string, memo string, reference string, height string, registrationHash string, registeredBy string, ) *ReferenceMemoResponse`
